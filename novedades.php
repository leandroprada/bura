     ...
     <!--    <div class="section-header">
        ...
        <!-- Portfolio Recent Projects -->
		 ...
		 <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="img/novedades/seleccionITAvanzadoMarzo2021.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/novedades/seleccionITAvanzadoMarzo2021.jpg"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">Ver Curso</a>
                    </div>
                  </div>
		  ...
		  <div class="col-lg-4 col-md-6 col-xs-12 mix print">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="img/novedades/seleccionITMarzo2021.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
		 ...
		 <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="img/novedades/seleccionITFebrero2021.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/novedades/seleccionITFebrero2021.jpg"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">Ver Curso</a>
                    </div>
                  </div>
		  ...
		  <div class="col-lg-4 col-md-6 col-xs-12 mix print">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="img/novedades/seleccionITAvanzadoFebrero2021.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/novedades/seleccionITAvanzadoFebrero2021.jpg"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">Ver Curso</a>
                    </div>
                  </div>
		  ...
		  <div class="col-lg-4 col-md-6 col-xs-12 mix design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="img/novedades/webDevFEVer2021.jpg" alt="" />
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="img/novedades/webDevFEVer2021.jpg"><i class="lni-zoom-in item-icon"></i></a>
                      </div>
                      <a href="#">Ver Curso</a>
                    </div>
                  </div>
        ...
        <div class="row justify-content-center">
          <div class="col-10">
            <div class="cta-trial text-center">
              ...
              <a href="mailto:burastchr@gmail.com?subject=Contacto desde tu web: Consulta Búsquedas y seleccion de Personal" target="_blank" class="btn btn-common btn-effect">Contactanos!</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              ...
              <ul class="footer-social">
                <li><a class="facebook" href="https://www.facebook.com/burastchr-675557912900923/" target="_blank"><i class="lni-facebook-filled"></i></a></li>
                <li><a class="linkedin" href="https://www.linkedin.com/in/burastchr/" target="_blank"><i class="lni-linkedin-fill"></i></a></li>
                <li><a class="google-plus" href="mailto:burastchr@gmail.com?subject=Contacto desde tu web: Consulta Búsquedas y seleccion de Personal" target="_blank"><i class="lni-google-plus"></i></a></li>
              </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              <div class="widget">
